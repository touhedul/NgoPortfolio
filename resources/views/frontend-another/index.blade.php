                ...
                <div class="who-we">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p class="text-justify">Shataphool Bangladesh is a non-government, not-for-profit,
                                non-sectarian, and non-political organization working for social development of vulnerable
                                people who haven’t progressed as they should have.
                                In 2000, the organization came into being when Mr. M. Shafiqul Islam (UNO of Mohanpur
                                Upazila) founded it with a group of young and energetic people, who were highly motivated
                                and committed to contributing their time, skills and energies for the development and
                                empowerment of socially disadvantaged and vulnerable communities in Mohanpur, addressing
                                poverty issues and eliminating gender based discriminations. By 2001, Shataphool Bangladesh
                                evolved into a formal institution offering micro-credit to poor rural women in Jahanabad
                                Union of Mohanpur Upazila.
                                Over the next decade the micro credit program diversified, and the organization began
                                providing a variety of micro-credit products for its heterogeneous group of family
                                entrepreneurs, alongside various types of social development programs.</p>
                        </div>
                        <div class="col-md-6">
                            ...
                            <ul class="row">
                                ...
                                <li class="col-sm-12"> <i class="fa fa-eye"></i>
                                    <h5>our vision</h5>
                                    <p class="text-justify">To ensure the sustainable economic development which provides
                                        human rights, mainstreams gender equality, ensures social justice, assures good
                                        governance by active participation of multi-tier people of society through poor
                                        friendly microfinance services.</p>
                                </li>

                                <!-- SERVICES -->
                                <li class="col-sm-12"> <i class="fa fa-rocket"></i>
                                    <h5>our mission</h5>
                                    <p class="text-justify">To establish an apolitical, cosmopolitan, not-for-profit,
                                        socioeconomic and philanthropic private voluntary organization which will work with
                                        the mission of making people self-dependent of all the religions and color,
                                        especially regenerating those who are impoverished and underprivileged.</p>
                                </li>
                ...
                <div class="row blog-slide">
                    ...
                    @foreach ($programs as $program)
                        <div class="col-md-12 no-padding">
                            <article> <img class="img-responsive" src="{{ asset('program_images/' . $program->image) }}"
                                    alt="">
                ...
                @foreach ($projects as $project)
                    <div class="cbp-item ana dial growth">
                        <article class="item"><img class="img-responsive"
                                src="{{ asset('program_images/' . $project->image) }}" alt="">
                            <!-- Hover -->
        ...
        <section class="counter padding-top-30 padding-bottom-30">
            <div class="container">
                ...
                <ul class="row">
                    ...
                    <li class="col-md-3">
                        <div class="count"> <span class="number"> <span class="timer" data-speed="2000"
                                    data-refresh-interval="10" data-to="{{ $numberOfEvent }}" data-from="0"></span>
                            </span>
                            <h5>Events</h5>
                        </div>
                    </li>
                    ...
                    <div class="container col-md-5 text-center" style="float: initial;">
                        <div class="job-content job-post-page margin-20" style="border: 0px;    padding-bottom: 20px;">
                            <div class="panel panel-default" style="border: 0px;">
                                <!-- Save -->
                                <div class="star-save"><a href="{{ $notice->programUrl() }}"><i
            ...
            <div id="owl-example2" class="owl-carousel">
                @foreach ($testimonials as $testimonial)
                    <div class="container col-md-12 text-center">
                        <img class="mt-img" src="{{ asset('testimonial_images/' . $testimonial->image) }}"
                            alt="">
                        <br>
                        <br>
