...
<section class="home-slide">
    <ul class="slides">
        ...
        <!-- SLIDER 1 -->
        <li class="slide-img-1" style="background: url('{{asset('gallery_images/big-'.$slider->image)}}'); background-repeat: no-repeat;  background-size: cover;" data-stellar-background-ratio="0.6">
