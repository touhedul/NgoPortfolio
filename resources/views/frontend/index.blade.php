        ...
        <ul>
            ...
            <li data-transition="" data-slotamount="7" data-masterspeed="1000" data-saveperformance="on">
                ...
                <div class="tp-caption sfb title-slide box style2
                        center bg-color color-white" data-x="266" data-y="247" data-speed="1000" data-start="1500"
                    data-easing="Power3.easeInOut">
                    {{ $slider->title }}</div>
                <div class="tp-caption sft desc-slide style1 box
                        center bg-dark color-white" data-x="266" data-y="365" data-speed="1000" data-start="1500"
...
<section class="flat-row portfolio-row-page" id="gallery" style="margin-bottom: 22px;">
    <div class="flat-portfolio v1">
        <div class="portfolio-wrap clearfix service_image">
            ...
            @if ($m < 6) <div class="item">
                <a href="" style="width:193px;height:125px;">
                    <img src="{{ asset('demo/' . $m . '.jpg') }}" alt="images">
                    <div class="overlay">
                    </div>
                    <div class="plus">
                        <a href="{{ route('service.type', preg_replace('/\s+/im', '_', $key)) }}">
                            <h2 style="font-size: 20px">{{ $key }} Service</h2>
                        </a>
                    </div>
                </a>
        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="">
                ...
                @if ($m <= 6) <article class="entry flat-animation" data-animation="fadeInUp" data-animation-delay="0"
                    data-animation-offset="75%">

                    <div class="entry-border" style="padding:10px;border:1px solid black">
                        <div class="feature-post">
                            <img style="height: 220px;width:100%" src="{{ asset('demo/' . $m . '.jpg') }}" alt="image">
                        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12 flat-animation" data-animation="fadeInRight" data-animation-delay="0"
                data-animation-offset="75%">
                <div class="flat-client" data-item="{{$clients->count()+1}}" data-nav="false" data-dots="false"
                    data-auto="true">
                    ...
                    <div class="flat-testimonials-slider">
                        ...
                        <div id="flat-testimonials-carousel">
                            <ul class="slides">
                                @foreach ($testimonials as $testimonial)
                                <li>
                                    <img alt="image" src="{{ asset('testimonial_images/' . $testimonial->image) }}">
                                </li>
                                @endforeach
                            </ul>
                        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="">
                    ...
                    @if ($key <= 2) <article class="entry" data-animation="fadeInUp" data-animation-delay="0"
                        data-animation-offset="75%">
...
<section class="flat-row parallax parallax3 bg-overlay
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12" data-animation="fadeInRight" data-animation-delay="0" data-animation-offset="75%">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="">
                    ...
                    @if ($key <= 3) <article class="entry" data-animation="fadeInUp" data-animation-delay="0"
                        data-animation-offset="75%">
                        <div class="entry-border">
                            <div class="feature-post">
                            ...
                            <div class="main-post">
                                ...
                                <div class="entry-content">
                                    ...
                                    {{-- <a href="{{ $event->programUrl() }}" style="color: red; font-size: 16px;">Read
                                        more</a> --}}
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="">
                    ...
                    @if ($key <= 4) <article class="entry" data-animation="fadeInUp" data-animation-delay="0"
                        data-animation-offset="75%">
                        <div class="entry-border">
                            <div class="feature-post">
...
<div class="flat-row pad-top60px pad-bottom0px bg-contact" id="contact_us">
    <div class="container">
        <p style="font-size: 32px; margin-bottom: 18px;">If any query or contact <a href="{{ route('contact.page') }}"
                style="color: orange">click here</a></p>
        <div class="row">
            <div class="col-md-4">
                <div class="widget-sv sv-information border
                flat-animation" data-animation="fadeInLeft" data-animation-delay="0" data-animation-offset="75%">
            ...
            <div class="col-md-8 flat-animation" data-animation="fadeInRight" data-animation-delay="0"
                data-animation-offset="75%">
                <iframe src="{{ setting('office_map') }}" width="100%" height="400" frameborder="0" style="border:0;"
