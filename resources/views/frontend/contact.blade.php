...
<section class="padding-top-70">
    <div class="container">
        <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d58144.53047175591!2d88.57099636236786!3d24.380150026228986!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39fbefa96a38d031%3A0x10f93a950ed6f410!2sRajshahi!5e0!3m2!1sen!2sbd!4v1595540829142!5m2!1sen!2sbd"
    ...
    <div class="col-md-6"><br>
        ...
        <form class="contact-form" data-parsley-validate method="POST" action="{{route('submit.feedback')}}">
            ...
            <div class="form-group">
                ...
                <input data-parsley-trigger="change" required value="{{old('phone')}}" required type="text"
                    class="form-control" id="exampleInputEmail1" name="phone" aria-describedby="emailHelp"
                    placeholder="Enter phone">

            </div>
            <div class="form-group">
                Message* <textarea name="message" required class="form-control" id="exampleFormControlTextarea1"
                ...
                <ul class="row" style="height: inherit;">
                    <li class="col-md-12" style="height: inherit;">
                        <article style="height: inherit; padding-top: 90px;">
                            <h5>Head Office</h5>
                            <p>মোহনপুরের জাহানাবাদ
                                <p>
                                    <p>Rajshahi 3000 Bangladesh </p>
                                    <span class="margin-top-30"><i class="fa fa-phone"></i> 880 1958-454545</span>
                                    <span class="primary-color"><i class="fa fa-envelope"></i> contact@sotoful.com</span>
                        </article>
                    </li>
                </ul>
            </div>
