...
<div class="col-md-12">
    <div class="card card-default">
        ...
        <div class="card-body">
            <form data-parsley-validate enctype="multipart/form-data" action="{{route('admin.branch.store')}}"
                method="POST">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <textarea id="editor" rows="30" required style="background: #f5f6fa" name="details"
                        class="form-control" placeholder="Branch Details">{{old('details')}}</textarea>
                </div>
                <div class="form-group">
                    <label>Phone*</label>
