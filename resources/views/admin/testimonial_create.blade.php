...
<div class="col-md-12">
    <div class="card card-default">
        ...
        <div class="card-body">
            <form data-parsley-validate enctype="multipart/form-data" action="{{route('admin.testimonial.store')}}"
                method="POST">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <textarea id="editor" rows="30" required style="background: #f5f6fa" name="message"
                        class="form-control" placeholder="Testimonial Message">{{old('message')}}</textarea>
                </div>
                <div class="form-group">
